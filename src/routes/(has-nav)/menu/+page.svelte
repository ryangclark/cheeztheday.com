...
>
	<p class="text-center">
		All sandwiches are grilled on sourdough, with a cripy dill pickle and a
		choice of side.
	</p>
...
>
	...
	<div>
		...
		<p class="my-2">
			...
			noodles, and sweet poppyseed viniagrette | <span class="font-bold"
				>V, GF</span
			>
		</p>
